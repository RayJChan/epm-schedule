package com.midea.epm.common.fifter;

import com.midea.epm.common.entity.ResponseCode;
import com.midea.epm.common.entity.ResponseResult;
import com.midea.epm.common.shiro.JwtToken;
import com.midea.epm.common.util.GsonUtil;
...
//		responseResult.setCode(ResponseCode.TOKEN_FAIL.getCode());
//		responseResult.setMsg(ResponseCode.TOKEN_FAIL.getMsg());
//		HttpServletResponse httpResponse = WebUtils.toHttp(servletResponse);
//		httpResponse.setCharacterEncoding("UTF-8");
//		httpResponse.setContentType("application/json;charset=UTF-8");
//		httpResponse.setStatus(HttpStatus.UNAUTHORIZED.value());
//		PrintWriter writer = httpResponse.getWriter();
//		writer.write(GsonUtil.GsonString(responseResult));
...
//			httpResponse.setHeader(JWTUtils.AUTH_HEADER, newToken);
	...
	protected boolean onLoginFailure(AuthenticationToken token, AuthenticationException e, ServletRequest servletRequest,
		...
		ResponseResult responseResult = new ResponseResult();
		responseResult.setCode(jwtToken.getJwtResult().getCode());
		responseResult.setMsg(jwtToken.getJwtResult().getMsg());
